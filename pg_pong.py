...
Uses Gymnasium (modern successor to OpenAI Gym).

Based on Andrej Karpathy's blog post:
https://karpathy.github.io/2016/05/31/rl/

Original code: https://gist.github.com/karpathy/a4166c7fe253700972fcbc77e4ea32c5
Adapted for Python 3 + Gymnasium API.
"""
...
csv_file = open('train_log_v0.csv', 'w', newline='')
